...
import { FileText, Trash2, Sparkles, Loader2, Wand2, ImagePlus } from "lucide-react";
...
interface PromptInputProps {
  ...
  onSuggestDialogChange?: (open: boolean) => void;
  onGenerateImage?: () => void;
}

export default function PromptInput({ prompts, onChange, disabled = false, brandStyle, suggestDialogOpen, onSuggestDialogChange, onGenerateImage }: PromptInputProps) {
  ...
  const showPromptCountDialog = suggestDialogOpen !== undefined ? suggestDialogOpen : internalDialogOpen;
  const setShowPromptCountDialog = onSuggestDialogChange || setInternalDialogOpen;
          ...
          {lineCount === 0 ? (
            <div className="border-2 border-dashed rounded-xl p-8 text-center bg-muted/30">
              ...
              <p className="text-sm text-muted-foreground/70 mb-4">
                Click "Generate Images" to generate prompts based on your brand, or type your own below
              </p>
              <Textarea
                value={prompts}
